...
def generate_activity_timeline() -> typing.List[typing.List[str]]:
    ...
    activity = [
        [
            ("/state/worker_a", "INITIALISED", "Worker A", right_arrow + space + 'And his noodly appendage reached forth to tickle the blessed...')
        ],
        [
        ...
        [
            ...
            ("/state/worker_c", "INITIALISED", "Worker C", right_arrow + space + 'boinked')
        ],
    ]
    formatted_activity = []
